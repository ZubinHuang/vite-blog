    ...
    <div class="meta-item">
      ...
      <span class="meta-content">
        <span v-for="(tag, index) in tags" :key="index">
          <a class="tag-a" href="javascript:void(0);" :title="tag">{{ tag }}</a>
        </span>
      </span>
    </div>
    <!-- <div class="meta-item">
      ...
      <span class="meta-content">
        <span v-for="(category, index) in categories" :key="index">
          <a href="javascript:void(0);" target="_self" :title="category">{{ category }}</a>
...
const data = reactive({
  author: frontmatter?.value?.userName || "AaronWong",
  link: frontmatter?.value?.link || "https://github.com/ZubinHuang",
